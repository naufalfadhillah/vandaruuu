                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="footer-item">
                        ...
                        <ul class="social-list">
                            <li><a href="index.html#" class="twitter-bg"><i class="fa fa-twitter"></i></a></li>
                            <li><a href="index.html#" class="facebook-bg"><i class="fa fa-facebook"></i></a></li>
                            <li><a href="index.html#" class="rss-bg"><i class="fa fa-rss"></i></a></li>
                            <li><a href="index.html#" class="google-bg"><i class="fa fa-google-plus"></i></a></li>
